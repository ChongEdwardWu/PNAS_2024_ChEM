...
cr_path <- file.path("/ifs1/User/yangbinVM/01.Project/wuchong/data/Peritoneal_ChAT/CRcount/Pos/outs/filtered_feature_bc_matrix")

## ! path to loom
loom_path <- file.path("/ifs1/User/yangbinVM/01.Project/wuchong/data/Peritoneal_ChAT/CRcount/Pos/velocyto/Pos.loom")
...
# Run in server
# nohup Rscript --vanilla /ifs1/User/yangbinVM/01.Project/wuchong/data/scRNAseq-R/Pos/Pos_scRNA_QC_step2.R &
