...
cr_path <- file.path("/ifs1/User/yangbinVM/01.Project/wuchong/data/Peritoneal_ChAT/CRcount/Neg/outs/filtered_feature_bc_matrix")

## ! path to loom
loom_path <- file.path("/ifs1/User/yangbinVM/01.Project/wuchong/data/Peritoneal_ChAT/CRcount/Neg/velocyto/Neg.loom")
...
# Run in server
# nohup Rscript --vanilla /ifs1/User/yangbinVM/01.Project/wuchong/data/scRNAseq-R/Neg/Neg_scRNA_QC_step2.R &
