...
sce <- read10xCounts("/ifs1/User/yangbinVM/01.Project/wuchong/data/Peritoneal_ChAT/CRcount/KO/outs/filtered_feature_bc_matrix", col.names = T)
...
# !Run in server
nohup Rscript --vanilla /ifs1/User/yangbinVM/01.Project/wuchong/data/scRNAseq-R/KO/KO_scRNA_QC_step1.R &
