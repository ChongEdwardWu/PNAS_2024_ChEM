...
cr_path <- file.path("/ifs1/User/yangbinVM/01.Project/wuchong/data/Peritoneal_ChAT/CRcount/KO/outs/filtered_feature_bc_matrix")

## ! path to loom
loom_path <- file.path("/ifs1/User/yangbinVM/01.Project/wuchong/data/Peritoneal_ChAT/CRcount/KO/velocyto/KO.loom")
...
colData(norm)$discard.cl <- ifelse(norm$label %in% c(
  13,15,19,26,28,32,34,38,# , # doublets
  4,6,22,29,30,35 # bad cells
   # RBCs and platelets
),
1, 0
)
...
# Run in server
# nohup Rscript --vanilla /ifs1/User/yangbinVM/01.Project/wuchong/data/scRNAseq-R/KO/KO_scRNA_QC_step2.R &
